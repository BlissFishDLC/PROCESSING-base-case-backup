...
void setup(){
  ...
  strokeSlider = gui.addSlider("strokeSize").setPosition(10,10).setRange(100, 500).setSize(200,19);
  rSlider = gui.addSlider("r").setPosition(10,30).setRange(0,255).setSize(200,19);
  gSlider = gui.addSlider("g").setPosition(10,50).setRange(0,255).setSize(200,19);
  bSlider = gui.addSlider("b").setPosition(10,70).setRange(0,255).setSize(200,19);

  gui.addButton("saveImage").setPosition(10,90).setSize(200,19);
}
